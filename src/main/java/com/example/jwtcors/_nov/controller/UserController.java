...
import com.example.jwtcors._nov.dto.AdminPanelResponse;
...
public class UserController {
    ...
    public AdminPanelResponse adminPanel(Authentication auth){
        ...
        return new AdminPanelResponse("Panel Administrativo", user.getId(), user.getUsername(), user.getRole().name(),user.getRole().permissions);
    }
